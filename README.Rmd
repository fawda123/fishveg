...
* `fish_dat.RData` DNR CPUE fisheries data, one row per fish.  Months are June through September, standard population assessments and re-surveys.  Sampling gear are gillnet, trapnets, beach seines (15, 50 ft), and backpack electrofishing. Lakes without all three were removed.
