...
ppp <- princomp(d[,c( "Depth", "Secchi", "Area", "SI", "ShedArea", "Human", "Bluegill")], cor=TRUE)
...
p1 <- ggord(ppp, grp_in = d$Group, vec_ext = 7, facet = T, nfac = 4, alpha = 0.8, size = 2, txt = 2, arrow = 0.2) + 
  mythm

p2 <- ggord(ppp, axes = c(3, 4), grp_in = d$Group, vec_ext = 7, facet = T, nfac = 4, alpha = 0.8, size = 2, arrow = 0.2, txt = 2) + 
  mythm
