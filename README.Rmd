...
```{r Fig3_ellp, fig.height = 6, fig.width = 6}
...
p <- ggord(ppp, grp_in = d$Group, vec_ext = 5, alpha = 0.7, size = d$abuall, txt = 4, arrow = 0.3, repel = T, ellipse = T, sizelab = 'Abundance') + 
...
```{r Fig3_noellp, fig.height = 6, fig.width = 6}

p <- ggord(ppp, grp_in = d$Group, vec_ext = 5, alpha = 0.7, size = d$abuall, txt = 4, arrow = 0.3, repel = T, ellipse = F, sizelab = 'Abundance') + 
  scale_size(range = rngs) +
  mythm
